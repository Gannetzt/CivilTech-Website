                  ...
                  {filteredDocuments.map((doc) => (
                    ...
                    >
                      ...
                      <div className="col-span-3 md:col-span-2 flex justify-end items-center gap-3">
                        ...
                        <button className="flex items-center gap-2 bg-primary hover:bg-primary/90 text-primary-foreground px-4 py-2 rounded-lg text-sm font-bold transition-all shadow-sm">
