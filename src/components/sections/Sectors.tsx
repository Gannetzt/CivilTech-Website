...
const sectors = [
  {
    title: 'Airports',
    description: 'Our turnkey construction and maintenance solutions are used by some of the world\'s biggest airports, from terminal to runway.',
  ...
  },
  {
    ...
    description: 'We have global experience in providing robust chemical and process structure solutions, increasingly including nuclear infrastructure.',
  ...
  {
    title: 'Rail',
    description: 'You\'ll find our rail infrastructure solutions in key international projects, from London to Adelaide.',
  ...
  {
    title: 'Water',
    description: 'We help waterproof and protect structures worldwide against chemical attacks, joint-leaks, cracks and surface corrosion.',
    ...
    <section className="py-16 lg:py-24 bg-gray-50" id="sectors">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {sectors.map((sector) => (
            ...
            >
              ...
              <div className="p-5 sm:p-6">
                ...
                <button className="flex items-center gap-2 text-blue-900 font-bold hover:text-green-600 transition-all group-hover:gap-3 text-sm">
        ...
        <div className="bg-gradient-to-r from-blue-900 via-blue-800 to-green-600 rounded-2xl p-8 sm:p-12 text-center shadow-xl relative overflow-hidden">
          ...
          <button className="bg-white hover:bg-green-500 hover:text-white text-blue-900 px-8 py-4 rounded-xl transition-all duration-300 inline-flex items-center gap-2 font-bold shadow-lg hover:shadow-green-500/20 relative z-10 text-sm sm:text-base">
            View All Brochures
